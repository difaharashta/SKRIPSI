...
<?php
  $id = $_GET['id'];
   $query = "select * from architect_perusahaan where architect_perusahaan_id='$id'";
                ...
                <div class="login-panel panel panel-default" style="margin-top:10%">
                    ...
                    <div class="panel-body">
                        ...
                        <div id="form-box" style="padding:25px 0px">
                            <form role="form" method="post" action="perusahaan-update.php">
                                        <div class="form-group">
                                            <input required type="hidden" value="<?php echo $id; ?>" name="id"/>
                                            <label>Nama Perusahaan</label>
                                            <input class="form-control" value="<?php echo $data['architect_perusahaan_nama']; ?>" type="text" name="nama" placeholder="Masukkan Nama Perusahaan"/>
                                        </div>
                                      
                                      <div class="form-group">
                                            <label>Email Perusahaan</label>
                                            <input  required class="form-control" value="<?php echo $data['architect_perusahaan_email']; ?>" type="email" name="email" placeholder="Masukkan Email Perusahaan"/>
                                        </div>
                                      <div class="form-group">
                                            <label>Alamat Perusahaan</label>
                                            <textarea required class="form-control" name="alamat" placeholder="Masukkan Alamat Lengkap Perusahaan"> <?php echo $data['architect_perusahaan_alamat']; ?> </textarea>
                                        </div>
                                      <div class="form-group">
                                            <label>Provinsi
											</label>
                                        ...
                                        <div class="form-group">
                                            <label>Kota</label>
                                            <input required class="form-control" value="<?php echo $data['architect_perusahaan_kota']; ?>" type="text" name="kota" placeholder="Masukkan Kota Asal"/>
                                        </div>
                                        <div class="form-group">
